...
static const yytype_uint16 yyprhs[] =
{
      ...
      26,    29,    31,    35,    37,    40,    44,    49,    54,    58,
      61,    63,    67,    70,    73,    78,    79,    82,    85,    87,
      91,    97,   105,   111,   121,   126,   130,   136,   139,   141,
     143,   144,   147,   150,   154,   156,   160,   162,   166,   170,
     174,   178,   182,   186,   189,   192,   196,   199,   202,   206,
     210,   214,   217,   220,   223,   226,   231,   235,   237,   239,
     241,   243,   245,   248,   253,   258,   263,   268,   272
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      86,     0,    -1,    87,    -1,    -1,    88,    87,    -1,    89,
      91,    20,    -1,    89,    94,    97,    -1,    90,   104,    20,
      -1,     1,    20,    -1,     6,    -1,    23,     6,    -1,    92,
      -1,    92,    21,    91,    -1,     4,    -1,     4,    93,    -1,
      16,   105,    17,    -1,    16,   105,    17,    93,    -1,     4,
      14,    95,    15,    -1,     4,    14,    15,    -1,     1,    19,
      -1,    96,    -1,    96,    21,    95,    -1,     1,    19,    -1,
      89,    92,    -1,    18,   101,    98,    19,    -1,    -1,    99,
      98,    -1,   105,    20,    -1,    97,    -1,    41,   105,    20,
      -1,    38,    14,   105,    15,    99,    -1,    38,    14,   105,
      15,    99,    39,    99,    -1,    40,    14,   105,    15,    99,
      -1,    42,    14,   105,    20,   105,    20,   105,    15,    99,
      -1,    44,   105,    22,    99,    -1,    45,    22,    99,    -1,
      43,    14,   105,    15,    99,    -1,   100,    20,    -1,    11,
      -1,    12,    -1,    -1,   102,   101,    -1,     1,    20,    -1,
      89,   103,    20,    -1,   104,    -1,   104,    21,   103,    -1,
      92,    -1,    92,    30,   105,    -1,   105,    30,   105,    -1,
     105,    35,   105,    -1,   105,    36,   105,    -1,   105,     5,
     105,    -1,   105,    24,   105,    -1,   105,    25,    -1,    25,
     105,    -1,   105,    26,   105,    -1,   105,    27,    -1,    27,
     105,    -1,   105,    28,   105,    -1,   105,    29,   105,    -1,
      14,   105,    15,    -1,    26,   105,    -1,    37,   105,    -1,
      13,   105,    -1,   105,    13,    -1,     4,    14,   106,    15,
      -1,     4,    14,    15,    -1,     4,    -1,     3,    -1,     8,
      -1,     9,    -1,    10,    -1,     4,    93,    -1,   105,    24,
      30,   105,    -1,   105,    26,    30,   105,    -1,   105,    28,
      30,   105,    -1,   105,    29,    30,   105,    -1,   105,    21,
     106,    -1,   105,    -1
};
...
{
       0,    61,    61,    66,    67,    72,    73,    74,    75,    80,
      86,    90,    91,    96,    97,   101,   102,   108,   109,   110,
     115,   116,   117,   122,   127,   132,   133,   138,   139,   140,
     141,   142,   143,   144,   145,   146,   147,   148,   152,   153,
     157,   158,   159,   164,   169,   170,   175,   176,   181,   182,
     183,   184,   185,   186,   187,   188,   189,   190,   191,   192,
     193,   194,   195,   196,   197,   198,   199,   200,   201,   202,
     203,   204,   205,   207,   208,   209,   210,   215,   216
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CASE", "DEFAULT", "ARRAY", "ARRAY_USE", "EXT_DEF_LIST", "EXT_VAR_DEF",
  "EXT_VARCONST_DEF", "FUNC_DEF", "FUNC_DEC", "EXT_DEC_LIST", "ARRAY_LIST",
  "ARRAY_LIST_CALL", "PARAM_LIST", "PARAM_DEC", "VAR_DEF", "DEC_LIST",
  "DEF_LIST", "COMP_STM", "STM_LIST", "EXP_STMT", "SKIP_SEMI", "IF_THEN",
  "IF_THEN_ELSE", "CASE_THEN", "DEFAULT_THEN", "FUNC_CALL", "ARGS",
  "FUNCTION", "PARAM", "ARG", "CALL", "LABEL", "GOTO", "JLT", "JLE", "JGT",
  "JGE", "EQ", "NEQ", "UMINUS", "LOWER_THEN_ELSE", "$accept", "program",
  "ExtDefList", "ExtDef", "Specifier", "ConstSpecifier", "ExtDecList",
  "VarDec", "ARRAYLIST", "FuncDec", "VarList", "ParamDec", "CompSt",
  "StmList", "Stmt", "SKIP", "DefList", "Def", "DecList", "Dec", "Exp",
  "Args", 0
};
#endif
...
{
       0,     0,     9,     0,     0,     2,     0,     0,     0,     8,
      10,     1,     4,     0,    13,     0,    11,     0,    13,    46,
       0,    19,     0,     0,    14,     5,     0,     0,     6,     0,
       7,     0,    18,     0,     0,    20,    68,    67,    69,    70,
      71,     0,     0,     0,     0,     0,     0,     0,    12,     0,
       0,    25,     0,    47,    22,    23,    17,     0,     0,    72,
      63,     0,    54,    61,    57,    62,     0,    64,    15,     0,
      53,     0,    56,     0,     0,     0,     0,     0,    42,     0,
      44,    38,    39,     0,     0,     0,     0,     0,     0,     0,
      28,     0,    25,     0,     0,    41,    21,    66,    78,     0,
      60,    51,    16,     0,    52,     0,    55,     0,    58,     0,
      59,    48,    49,    50,    43,     0,     0,     0,     0,     0,
       0,     0,     0,    24,    26,    37,    27,     0,    65,    73,
      74,    75,    76,    45,     0,     0,    29,     0,     0,     0,
      35,    77,     0,     0,     0,     0,    34,    30,    32,     0,
      36,     0,     0,    31,     0,     0,    33
};
...
{
      -1,     4,     5,     6,     7,     8,    15,    19,    24,    17,
      34,    35,    90,    91,    92,    93,    51,    52,    79,    80,
      94,    99
};
...
{
      24,   -19,   -35,     6,    17,   -35,    24,   124,    29,   -35,
     -35,   -35,   -35,    21,    15,    22,    28,    45,    54,    46,
      57,   -35,   111,   229,   -35,   -35,    29,    97,   -35,   229,
     -35,    62,   -35,    29,    68,    64,   -35,    25,   -35,   -35,
     -35,   229,   229,   229,   229,   229,   229,   254,   -35,    69,
      29,   140,    97,    31,   -35,   -35,   -35,     7,     1,   -35,
      86,   272,    59,    86,    59,    86,   229,   -35,    54,    65,
     -35,   183,   -35,   191,   221,   229,   229,   229,   -35,    93,
      98,   -35,   -35,   100,   104,   229,   106,   113,   229,   108,
     -35,   112,   140,   116,   290,   -35,   -35,   -35,   308,   117,
     -35,   144,   -35,   229,    59,   229,    59,   229,    86,   229,
      86,   470,   504,   487,   -35,    29,   229,   229,   326,   229,
     229,   344,   140,   -35,   -35,   -35,   -35,   229,   -35,   470,
     470,   470,   470,   -35,   362,   380,   -35,   398,   416,   140,
     -35,   -35,   140,   140,   229,   140,   -35,    94,   -35,   434,
     -35,   140,   229,   -35,   452,   140,   -35
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
     -35,   -35,   139,   -35,   -20,   -35,   120,    38,   -34,   -35,
      90,   -35,   138,    67,   118,   -35,   109,   -35,    41,   152,
     -23,    35
};
...
{
      47,     9,    33,    59,    36,    37,    53,    50,    31,    38,
      39,    40,    10,     2,    41,    42,    97,    11,    60,    61,
      62,    63,    64,    65,    -3,     1,    43,    44,    45,    22,
       2,    23,    50,    18,   102,    98,    66,    33,    46,    58,
      21,    23,    25,   101,    67,    16,   104,     3,   106,    26,
     108,   110,   111,   112,   113,    69,    70,    71,    72,    73,
      74,    75,   118,    27,    16,   121,    76,    77,    36,    37,
      23,    55,    67,    38,    39,    40,    29,    30,    41,    42,
     129,    54,   130,    56,   131,    57,   132,    73,    74,    78,
      43,    44,    45,   134,   135,   103,   137,   138,    49,    67,
     -40,   -40,    46,     2,    98,   -40,   -40,   -40,   -40,   -40,
     -40,   -40,    31,   114,   116,   -40,   -40,     2,   117,   115,
     119,   149,   -40,   -40,   -40,    13,    32,   120,    14,   154,
     122,   123,   128,   151,   -40,   -40,   125,   -40,   -40,   -40,
     -40,   -40,   -40,    36,    37,    12,    48,    96,    38,    39,
      40,    81,    82,    41,    42,    28,   133,    67,    27,   124,
      20,    95,   141,     0,     0,    43,    44,    45,    69,    70,
      71,    72,    73,    74,     0,     0,     0,    46,    83,     0,
      84,    85,    86,    87,    88,    89,    36,    37,     0,     0,
       0,    38,    39,    40,    36,    37,    41,    42,     0,    38,
      39,    40,     0,     0,    41,    42,     0,     0,    43,    44,
      45,     0,     0,   105,     0,     0,    43,    44,    45,     0,
      46,   107,     0,     0,    36,    37,     0,     0,    46,    38,
      39,    40,    36,    37,    41,    42,     0,    38,    39,    40,
     140,     0,    41,    42,     0,     0,    43,    44,    45,     0,
       0,   109,     0,     0,    43,    44,    45,   146,    46,    66,
     147,   148,     0,   150,     0,     0,    46,    67,     0,   153,
       0,    68,     0,   156,     0,     0,     0,    66,    69,    70,
      71,    72,    73,    74,    75,    67,     0,   100,     0,    76,
      77,     0,     0,     0,     0,    66,    69,    70,    71,    72,
      73,    74,    75,    67,     0,     0,     0,    76,    77,     0,
     126,     0,     0,    66,    69,    70,    71,    72,    73,    74,
      75,    67,     0,     0,     0,    76,    77,     0,     0,   127,
       0,    66,    69,    70,    71,    72,    73,    74,    75,    67,
       0,     0,     0,    76,    77,     0,   136,     0,     0,    66,
      69,    70,    71,    72,    73,    74,    75,    67,     0,     0,
       0,    76,    77,     0,     0,     0,   139,    66,    69,    70,
      71,    72,    73,    74,    75,    67,     0,   142,     0,    76,
      77,     0,     0,     0,     0,    66,    69,    70,    71,    72,
      73,    74,    75,    67,     0,   143,     0,    76,    77,     0,
       0,     0,     0,    66,    69,    70,    71,    72,    73,    74,
      75,    67,     0,     0,     0,    76,    77,     0,   144,     0,
       0,    66,    69,    70,    71,    72,    73,    74,    75,    67,
       0,   145,     0,    76,    77,     0,     0,     0,     0,    66,
      69,    70,    71,    72,    73,    74,    75,    67,     0,     0,
       0,    76,    77,     0,   152,     0,     0,    66,    69,    70,
      71,    72,    73,    74,    75,    67,     0,   155,     0,    76,
      77,     0,     0,     0,     0,    66,    69,    70,    71,    72,
      73,    74,    75,    67,     0,     0,     0,    76,    77,     0,
       0,     0,    66,     0,    69,    70,    71,    72,    73,    74,
      67,     0,     0,     0,     0,    76,    77,     0,     0,    66,
       0,    69,    70,    71,    72,    73,    74,    67,     0,     0,
       0,     0,    76,     0,     0,     0,     0,     0,    69,    70,
      71,    72,    73,    74
};

static const yytype_int16 yycheck[] =
{
      23,    20,    22,    37,     3,     4,    29,    27,     1,     8,
       9,    10,     6,     6,    13,    14,    15,     0,    41,    42,
      43,    44,    45,    46,     0,     1,    25,    26,    27,    14,
       6,    16,    52,     4,    68,    58,     5,    57,    37,    14,
      19,    16,    20,    66,    13,     7,    69,    23,    71,    21,
      73,    74,    75,    76,    77,    24,    25,    26,    27,    28,
      29,    30,    85,    18,    26,    88,    35,    36,     3,     4,
      16,    33,    13,     8,     9,    10,    30,    20,    13,    14,
     103,    19,   105,    15,   107,    21,   109,    28,    29,    20,
      25,    26,    27,   116,   117,    30,   119,   120,     1,    13,
       3,     4,    37,     6,   127,     8,     9,    10,    11,    12,
      13,    14,     1,    20,    14,    18,    19,     6,    14,    21,
      14,   144,    25,    26,    27,     1,    15,    14,     4,   152,
      22,    19,    15,    39,    37,    38,    20,    40,    41,    42,
      43,    44,    45,     3,     4,     6,    26,    57,     8,     9,
      10,    11,    12,    13,    14,    17,   115,    13,    18,    92,
       8,    52,   127,    -1,    -1,    25,    26,    27,    24,    25,
      26,    27,    28,    29,    -1,    -1,    -1,    37,    38,    -1,
      40,    41,    42,    43,    44,    45,     3,     4,    -1,    -1,
      -1,     8,     9,    10,     3,     4,    13,    14,    -1,     8,
       9,    10,    -1,    -1,    13,    14,    -1,    -1,    25,    26,
      27,    -1,    -1,    30,    -1,    -1,    25,    26,    27,    -1,
      37,    30,    -1,    -1,     3,     4,    -1,    -1,    37,     8,
       9,    10,     3,     4,    13,    14,    -1,     8,     9,    10,
     122,    -1,    13,    14,    -1,    -1,    25,    26,    27,    -1,
      -1,    30,    -1,    -1,    25,    26,    27,   139,    37,     5,
     142,   143,    -1,   145,    -1,    -1,    37,    13,    -1,   151,
      -1,    17,    -1,   155,    -1,    -1,    -1,     5,    24,    25,
      26,    27,    28,    29,    30,    13,    -1,    15,    -1,    35,
      36,    -1,    -1,    -1,    -1,     5,    24,    25,    26,    27,
      28,    29,    30,    13,    -1,    -1,    -1,    35,    36,    -1,
      20,    -1,    -1,     5,    24,    25,    26,    27,    28,    29,
      30,    13,    -1,    -1,    -1,    35,    36,    -1,    -1,    21,
      -1,     5,    24,    25,    26,    27,    28,    29,    30,    13,
      -1,    -1,    -1,    35,    36,    -1,    20,    -1,    -1,     5,
      24,    25,    26,    27,    28,    29,    30,    13,    -1,    -1,
      -1,    35,    36,    -1,    -1,    -1,    22,     5,    24,    25,
      26,    27,    28,    29,    30,    13,    -1,    15,    -1,    35,
      36,    -1,    -1,    -1,    -1,     5,    24,    25,    26,    27,
      28,    29,    30,    13,    -1,    15,    -1,    35,    36,    -1,
      -1,    -1,    -1,     5,    24,    25,    26,    27,    28,    29,
      30,    13,    -1,    -1,    -1,    35,    36,    -1,    20,    -1,
      -1,     5,    24,    25,    26,    27,    28,    29,    30,    13,
      -1,    15,    -1,    35,    36,    -1,    -1,    -1,    -1,     5,
      24,    25,    26,    27,    28,    29,    30,    13,    -1,    -1,
      -1,    35,    36,    -1,    20,    -1,    -1,     5,    24,    25,
      26,    27,    28,    29,    30,    13,    -1,    15,    -1,    35,
      36,    -1,    -1,    -1,    -1,     5,    24,    25,    26,    27,
      28,    29,    30,    13,    -1,    -1,    -1,    35,    36,    -1,
      -1,    -1,     5,    -1,    24,    25,    26,    27,    28,    29,
      13,    -1,    -1,    -1,    -1,    35,    36,    -1,    -1,     5,
      -1,    24,    25,    26,    27,    28,    29,    13,    -1,    -1,
      -1,    -1,    35,    -1,    -1,    -1,    -1,    -1,    24,    25,
      26,    27,    28,    29
};
...
{
       0,     1,     6,    23,    86,    87,    88,    89,    90,    20,
       6,     0,    87,     1,     4,    91,    92,    94,     4,    92,
     104,    19,    14,    16,    93,    20,    21,    18,    97,    30,
      20,     1,    15,    89,    95,    96,     3,     4,     8,     9,
      10,    13,    14,    25,    26,    27,    37,   105,    91,     1,
      89,   101,   102,   105,    19,    92,    15,    21,    14,    93,
     105,   105,   105,   105,   105,   105,     5,    13,    17,    24,
      25,    26,    27,    28,    29,    30,    35,    36,    20,   103,
     104,    11,    12,    38,    40,    41,    42,    43,    44,    45,
      97,    98,    99,   100,   105,   101,    95,    15,   105,   106,
      15,   105,    93,    30,   105,    30,   105,    30,   105,    30,
     105,   105,   105,   105,    20,    21,    14,    14,   105,    14,
      14,   105,    22,    19,    98,    20,    20,    21,    15,   105,
     105,   105,   105,   103,   105,   105,    20,   105,   105,    22,
      99,   106,    15,    15,    20,    15,    99,    99,    99,   105,
      99,    39,    20,    99,   105,    15,    99
};
...
/* Line 1455 of yacc.c  */
#line 61 "parser.y"
    { /*display($1,0);*/ /*显示语法树*/ semantic_Analysis0((yyvsp[(1) - (1)].ptr));/*语义分析*/;}
    break;
...
/* Line 1455 of yacc.c  */
#line 97 "parser.y"
    {(yyval.ptr)=mknode(2,ARRAY,yylineno,(yyvsp[(1) - (2)].type_id),(yyvsp[(2) - (2)].ptr)); strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (2)].type_id));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 101 "parser.y"
    {(yyval.ptr)=mknode(1,ARRAY_LIST,yylineno,(yyvsp[(2) - (3)].ptr));  if((yyvsp[(2) - (3)].ptr)->type==INT) (yyval.ptr)->type_int=(yyvsp[(2) - (3)].ptr)->type_int;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 102 "parser.y"
    {(yyval.ptr)=mknode(2,ARRAY_LIST,yylineno,(yyvsp[(2) - (4)].ptr),(yyvsp[(4) - (4)].ptr));  if((yyvsp[(2) - (4)].ptr)->type==INT) (yyval.ptr)->type_int=(yyvsp[(2) - (4)].ptr)->type_int;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 200 "parser.y"
    {(yyval.ptr)=mknode(0,ID,yylineno); (yyval.ptr)->type=ID; strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (1)].type_id));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 204 "parser.y"
    {(yyval.ptr)=mknode(0,STRING,yylineno);strcpy((yyval.ptr)->type_string,(yyvsp[(1) - (1)].type_string));  splitQuote((yyval.ptr)->type_string);  (yyval.ptr)->type=STRING;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 205 "parser.y"
    {(yyval.ptr)=mknode(2,ARRAY_USE,yylineno,mknode(0,ID,yylineno),(yyvsp[(2) - (2)].ptr)); strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (2)].type_id));;}
    break;
